...
if __name__ == '__main__':
    ...
    # Filter out problematic keys that might not exist in current model structure
    if "model.vision_model.embeddings.position_ids" in state_dict:
        del state_dict["model.vision_model.embeddings.position_ids"]
        print("Removed 'model.vision_model.embeddings.position_ids' from state dict")
