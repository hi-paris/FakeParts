...
class BaseModel(nn.Module):
    def __init__(self, cfg: CONFIGCLASS):
        ...
        self.model = None  # will be set in Trainer subclass
...
class Trainer(BaseModel):
    ...
    def __init__(self, cfg: CONFIGCLASS):
        super().__init__(cfg)
        self.arch = cfg.arch
        self.model = get_network(self.arch, cfg.isTrain, cfg.continue_train, cfg.init_gain, cfg.pretrained).to(self.device)
